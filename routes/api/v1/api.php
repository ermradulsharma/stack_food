...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
        ...
        Route::group(['prefix'=>'timeslot'], function(){
            ...
            Route::put('update', 'TimeSlotController@update');
            Route::delete('delete', 'TimeSlotController@delete');
            Route::get('status', 'TimeSlotController@status');
            Route::POST('search', 'TimeSlotController@search');
            Route::get('reviews', 'TimeSlotController@reviews');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('place/subscribe', 'OrderController@place_order_subscribe');
    ...
    Route::group(['prefix' => 'coupon', 'middleware' => 'auth:api'], function () {
        ...
        Route::get('subscription', 'CouponController@subscription');
