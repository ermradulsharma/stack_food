...
class PaypalService implements PaymentGatewayInterface
{
    ...
    public function initialize(array $data)
    {
        ...
        try {
            ...
            return back()->withErrors(['error' => trans('messages.your_currency_is_not_supported', ['method' => trans('messages.paypal')])]);
        }

        return back()->withErrors(['error' => trans('messages.config_your_account', ['method' => trans('messages.paypal')])]);
    }
    ...
    {
        // For PayPal, failure is often handled by specific return URLs or within verify if execution fails.
        // This method can be used for explicit cancel URL handling.
        return redirect()->route('payment-fail');
    }
}
