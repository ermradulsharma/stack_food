    ...
    <nav class="navbar navbar-expand-lg navbar-light top-nav-bg">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                ...
                <img class="img-fluid w-100 logo" onerror="this.src='{{ asset('assets/admin/img/160x160/img2.jpg') }}'"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('contact-us') }}">{{ __('messages.contact_us') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            ...
                            @if ($landing_page_links['app_url_android_status'])
                                <a href="{{ $landing_page_links['app_url_android'] }}">
                                    <img class="img-fluid mr w-100"
                                        src="{{ asset('assets/landing') }}/image/playstore.png" alt="Play store" />
                                </a>
                            @endif
