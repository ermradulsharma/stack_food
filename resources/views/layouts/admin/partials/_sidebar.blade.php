        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content" style="background-color: #334257;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ __('messages.subscription') }} {{ __('messages.section') }}">{{ __('messages.subscription') }}
                            {{ __('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="{{ route('admin.subscription') }}" title="{{ __('messages.subscription') }}">
                            <i class="tio-city nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                    ...
                    <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/timeslot*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.timeslot.add-new') }}" title="{{ __('Time Slot') }}">
                                <i class="tio-gift nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('Time Slots') }}</span>
                            </a>
                        </li>
                    <!-- end Subscription -->
                    <!-- DeliveryMan -->
