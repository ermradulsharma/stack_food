                ...
                <form action="{{ env('APP_MODE') != 'demo' ? route('vendor.profile.update') : 'javascript:' }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            for="avatarUploader">
                            <img id="viewer" onerror="this.src='{{ asset('admin/img/160x160/img1.jpg') }}'" class="avatar-img" src="{{ asset('storage/app/' . (auth('vendor')->check() ? auth('vendor')->user()->image : auth('vendor_employee')->user()->image)) }}" alt="Image">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                    class="col-sm-3 col-form-label input-label">{{ __('messages.full_name') }} <i
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                            ...
                                            aria-label="{{ __('messages.your_first_name') }}"
                                        ...
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                            ...
                                            aria-label="{{ __('messages.your_last_name') }}"
                            ...
                            <div class="row form-group">
                                <label for="phoneLabel"
                                    class="col-sm-3 col-form-label input-label">{{ __('messages.phone') }} <span
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                    class="col-sm-3 col-form-label input-label">{{ __('messages.email') }}</label>

                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                        value="{{ auth('vendor')->check() ? auth('vendor')->user()->email : auth('vendor_employee')->user()->email }}"
                                        placeholder="{{ __('messages.enter_new_email_address') }}"
                                        aria-label="{{ __('messages.enter_new_email_address') }}">
                                </div>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="@if (env('APP_MODE') != 'demo') form_alert('vendor-settings-form','{{ __('messages.you_want_to_update_user_info') }}') @else call_demo() @endif"
                        ...
                        <form id="changePasswordForm"
                            ...
                            <div class="row form-group">
                                <label for="newPassword"
                                    class="col-sm-3 col-form-label input-label">{{ __('messages.new_password') }}</label>
                            ...
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel"
                                    class="col-sm-3 col-form-label input-label">{{ __('messages.confirm_password') }}</label>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="@if (env('APP_MODE') != 'demo') form_alert('changePasswordForm', '{{ __('messages.want_to_update_password') }}') @else call_demo() @endif"
                                    class="btn btn-primary">{{ __('messages.save_changes') }}</button>
                            </div>
                        </form>
                        <!-- End Form -->
