                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    style="color: red">
                                    <span class="input-label-secondary" title="{{ translate('messages.including_food_delivery_fee_commission') }}"><img src="{{ asset('/assets/admin/img/info-circle.svg') }}"></span></small></h4>
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th  style="width: 14%">{{translate('messages.commission')}}</th>
