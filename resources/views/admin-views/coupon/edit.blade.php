            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Is Subscribe Coupon</label>
                                <select name="subscribe_type" class="form-control" >
                                    <option value="first_order" {{$coupon['subscribe_type'] == 0?'selected':''}}>No</option>
                                    <option value="default" {{$coupon['subscribe_type'] == 1 ?'selected':''}}>Yes</option>
                                </select>
                            </div>
                        </div>
                    </div>
