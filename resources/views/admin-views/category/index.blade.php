        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{isset($category)?route('admin.category.update',[$category['id']]):route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{__('messages.commission')}}</label>
                        <input type="number" name="commission" class="form-control" placeholder="{{__('messages.new_commission')}} in %" value="{{old('commission')}}" required maxlength="100">
                    </div>
                    <!-- <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">{{__('messages.name')}}</label>
                ...
                <div class="table-responsive datatable-custom">
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                <th style="width: 5%" class="text-center">{{__('messages.#')}}</th>
                                <th style="width: 10%" class="text-center">{{__('messages.id')}}</th>
                                <th style="width: 30%">{{__('messages.name')}}</th>
                                <th style="width: 20%" class="text-center">{{__('messages.commission')}}</th>
                                <th style="width: 10%" class="text-center">{{__('messages.status')}}</th>
                                <th style="width: 10%" class="text-center">{{__('messages.priority')}}</th>
                                <th style="width: 25%" class="text-center">{{__('messages.action')}}</th>
                            </tr>
                        </thead>
                        ...
                        @foreach($categories as $key=>$category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-warning p-2">{{$category->commission}}%</span>
                                </td>
                                <td class="text-center">
