            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="product_form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Is Subscribed</label>
                                <select name="subscribe_type" class="form-control" >
                                    <option value="0" {{$product['subscribe_type'] == 0?'selected':''}}>No</option>
                                    <option value="1" {{$product['subscribe_type'] == 1 ?'selected':''}}>Yes</option>
                                </select>
                            </div>
                        </div>
                    </div>
