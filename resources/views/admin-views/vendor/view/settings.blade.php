                            ...
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.free_delivery')}}<span class="input-label-secondary" title="{{__('messages.free_delivery_toggle_hint')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.free_delivery_toggle_hint')}}"></span>:</span>
                                            <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.vendor.toggle-settings',[$restaurant->id,$restaurant->free_delivery?0:1, 'free_delivery'])}}'" id="free_delivery" {{$restaurant->free_delivery?'checked':''}} {{$restaurant->self_delivery_system ? '' : 'disabled'}}>
